...
const orderedByLifeTime = inventors.sort((a, b) => (a.passed - a.year) - (b.passed - b.year));
console.table(orderedByLifeTime);


// 6. Create a list of Boulevards in Paris that contain 'de' anywhere in the game
